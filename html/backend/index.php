          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      ...
                      <li class="">
                          <a href="../backend/page-project.php" class="svg-icon">                        
                              <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      ...
                      <li class="">
                          <a href="../backend/page-task.php" class="svg-icon">                        
                              <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      ...
                      <li class="">
                          <a href="../backend/page-employee.php" class="svg-icon">                        
                              <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      ...
                      <li class="">
                          <a href="../backend/page-desk.php" class="svg-icon">                        
                              <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      ...
                      <li class="">
                          <a href="../backend/page-calender.php" class="svg-icon">                        
                              <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      ...
                      <li class=" ">
                          ...
                          <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  ...
                                  <li class="">
                                      <a href="../backend/timeline.php" class="svg-icon">
                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right border-none" aria-labelledby="dropdownMenuButton">
                                      ...
                                      <li class="dropdown-item d-flex svg-icon">
                                          ...
                                          <a href="../app/user-profile-edit.php">Edit Profile</a>
                                      </li>
                                      <li class="dropdown-item d-flex svg-icon">
                                          ...
                                          <a href="../app/user-account-setting.php">Account Settings</a>
                                      </li>
                                      <li class="dropdown-item d-flex svg-icon">
                                          ...
                                          <a href="../app/user-privacy-setting.php">Privacy Settings</a>
                                      </li>
            ...
            <div class="col-xl-4">
                <div class="card card-block card-stretch card-height p-1">
                    <div class="card-body">
                        ...
                        <div class="card card-body" style="background-color: #b8ffd0;
                        background-image :linear-gradient(315deg, #afffca 0%, #bceeff 74%);
                         border: 0;">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="pl-3 border-left fw-bold" style="border-color: black !important;">
                                    <h5 style="color: #000000;">Routine Meetup</h5>
                                    <p class="mb-0" style="color: #000000">July 1, 2023 @ 8:00 PM</p>
                                </div>
                            </div>
                            
                            <div class="card py-1" style="position: relative; margin-top: 5%; margin-bottom: 0; text-align: center; background-color: #ffffff;">
                                <a style=" color: #000000; font-weight:700;font-size: 18px;" href="https://meet.google.com/acx-dhbm-pdy">Join Meeting </a>
                            </div>
                        </div>

                        <div> 
                            <h5 >Hotel Management App UI Kit</h5>
                            <div style="float: right">
                                <a href="#" class="btn bg-secondary-light">Design</a>
                            </div>
                            <p class="mb-3" style="margin-top: 1%;"><i class="las la-calendar-check mr-2"></i>02 / 02 / 2021</p>
