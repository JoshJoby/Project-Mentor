...
<!-- Mirrored from themeadapt.com/tm/eduvalt/shop-details   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:52 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Shop</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="shop-details  ">Shop Details</a></li>
                                            </ul>
                                        </li>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="shop-details-images-wrap">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                    <a href="assets/img/shop/shop_details01.jpg" class="popup-image">
                                ...
                                <div class="tab-pane" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                    <a href="assets/img/shop/shop_details02.jpg" class="popup-image">
                                ...
                                <div class="tab-pane" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
                                    <a href="assets/img/shop/shop_details03.jpg" class="popup-image">
                                        <img src="assets/img/shop/shop_details01.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="shop-details-content">
                            <h2 class="title">SEO Tricks & Tips</h2>
                            ...
                            <div class="shop-details-qty">
                                ...
                                <a href="shop-details  " class="cart-btn btn">Add To Cart</a>
                                <a href="shop-details  " class="wishlist-btn"><i class="far fa-heart"></i></a>
                            </div>
                            <div class="shop-details-bottom">
                                <ul class="list-wrap">
                                    ...
                                    <li class="sd-category">
                                        ...
                                        <a href="shop-details  ">Business & Marketing</a>
                                    </li>
                                    <li class="sd-tag">
                                        <span class="title">Tags:</span>
                                        <a href="shop-details  ">Coaching,</a>
                                        <a href="shop-details  ">Education</a>
                                    </li>
                                    <li class="sd-share">
                ...
                <div class="related-product-area">
                    <div class="section__title mb-50">
                        <h2 class="title tg-svg">Related <span class="position-relative"><span class="svg-icon" id="related-title" data-svg-icon="assets/img/icons/title_shape.svg"></span>products</span></h2>
                    </div>
                    <div class="row shop-active">
                        <div class="col-lg-4">
                            <div class="shop-item">
                                <div class="shop-thumb">
                                    <a href="shop-details  "><img src="assets/img/shop/shop_img01.jpg" alt=""></a>
                        ...
                        <div class="col-lg-4">
                            <div class="shop-item">
                                <div class="shop-thumb">
                                    <a href="shop-details  "><img src="assets/img/shop/shop_img02.jpg" alt=""></a>
                                    <div class="shop-action">
                                        <a href="shop-details  "><i class="fas fa-shopping-cart"></i></a>
                                        <a href="shop-details  "><i class="far fa-eye"></i></a>
                                        <a href="shop-details  "><i class="far fa-heart"></i></a>
                        ...
                        <div class="col-lg-4">
                            <div class="shop-item">
                                <div class="shop-thumb">
                                    <a href="shop-details  "><img src="assets/img/shop/shop_img03.jpg" alt=""></a>
                                    <div class="shop-action">
                                        <a href="shop-details  "><i class="fas fa-shopping-cart"></i></a>
                                        <a href="shop-details  "><i class="far fa-eye"></i></a>
                                        <a href="shop-details  "><i class="far fa-heart"></i></a>
                        ...
                        <div class="col-lg-4">
                            <div class="shop-item">
                                <div class="shop-thumb">
                                    <a href="shop-details  "><img src="assets/img/shop/shop_img04.jpg" alt=""></a>
                                    <div class="shop-action">
                                        <a href="shop-details  "><i class="fas fa-shopping-cart"></i></a>
                                        <a href="shop-details  "><i class="far fa-eye"></i></a>
                                        <a href="shop-details  "><i class="far fa-heart"></i></a>
                        ...
                        <div class="col-lg-4">
                            <div class="shop-item">
                                <div class="shop-thumb">
                                    <a href="shop-details  "><img src="assets/img/shop/shop_img05.jpg" alt=""></a>
                                    <div class="shop-action">
                                        <a href="shop-details  "><i class="fas fa-shopping-cart"></i></a>
                                        <a href="shop-details  "><i class="far fa-eye"></i></a>
                                        <a href="shop-details  "><i class="far fa-heart"></i></a>
...
<!-- Mirrored from themeadapt.com/tm/eduvalt/shop-details   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:54 GMT -->
</html>