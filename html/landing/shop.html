                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-8">
                        <aside class="shop-sidebar">
                            ...
                            <div class="shop-widget">
                                <h4 class="widget-title">Filter by Author</h4>
                                <div class="shop-cat-list">
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_8">
                                                <label class="form-check-label" for="cat_8">Kiran Molly (11)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_9">
                                                <label class="form-check-label" for="cat_9">Jackson Alive (12)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_10">
                                                <label class="form-check-label" for="cat_10">Data Science (7)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_11">
                                                <label class="form-check-label" for="cat_11">Oawe Alve (9)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_12">
                                                <label class="form-check-label" for="cat_12">Liakon Rivey (9)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_13">
                                                <label class="form-check-label" for="cat_13">Foley Patrik (9)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_14">
                                                <label class="form-check-label" for="cat_14">Kiran Molly (11)</label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="shop-widget">
                                ...
                                <div class="shop-cat-list">
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_15">
                                                <label class="form-check-label" for="cat_15">China (7)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_16">
                                                <label class="form-check-label" for="cat_16">English (11)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_17">
                                                <label class="form-check-label" for="cat_17">French (5)</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="cat_18">
                                                <label class="form-check-label" for="cat_18">German (7)</label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
