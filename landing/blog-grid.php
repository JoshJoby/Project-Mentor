...
<!-- Mirrored from themeadapt.com/tm/eduvalt/blog-grid   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:54 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-xl-flex">
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Blog</a>
                                            <ul class="sub-menu">
                                                <li class="active"><a href="blog-grid  ">Blog Grid</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            <h3 class="title">Blog Grid Post</h3>
                            <nav class="breadcrumb">
                                <span property="itemListElement" typeof="ListItem">
                                    <a href="index  ">Home</a>
                                </span>
                                <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                                <span property="itemListElement" typeof="ListItem">Grid Post</span>
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb01.jpg" alt="img"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb02.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content">
                                <a href="#" class="cat">Course</a>
                                <h4 class="title"><a href="blog-details  ">Full Stack GraphQL With Next.js And Vercel</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 24 Aug, 2023</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb03.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content">
                                <a href="#" class="cat">Skill Development</a>
                                <h4 class="title"><a href="blog-details  ">What Leonardo Teach us About Web Design</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 24 Aug, 2023</li>
                                </ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb07.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content">
                                <a href="#" class="cat">Education</a>
                                <h4 class="title"><a href="blog-details  ">When aeunkno printer took galley of scrambled</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb08.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content">
                                <a href="#" class="cat">Course</a>
                                <h4 class="title"><a href="blog-details  ">Full Stack GraphQL With Next.js And Vercel</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb09.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content">
                                <a href="#" class="cat">Skill Development</a>
                                <h4 class="title"><a href="blog-details  ">What Leonardo Teach us About Web Design</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb10.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content">
                                <a href="#" class="cat">Education</a>
                                <h4 class="title"><a href="blog-details  ">When aeunkno printer took galley of scrambled</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb11.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content">
                                <a href="#" class="cat">Course</a>
                                <h4 class="title"><a href="blog-details  ">Full Stack GraphQL With Next.js And Vercel</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post-item shine__animate-item">
                            <div class="blog__post-thumb">
                                <a href="blog-details  " class="shine__animate-link"><img src="assets/img/blog/blog_thumb12.jpg" alt="img"></a>
                            </div>
                            <div class="blog__post-content">
                                <a href="#" class="cat">Skill Development</a>
                                <h4 class="title"><a href="blog-details  ">What Leonardo Teach us About Web Design</a></h4>
...
<!-- Mirrored from themeadapt.com/tm/eduvalt/blog-grid   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:57 GMT -->
</html>