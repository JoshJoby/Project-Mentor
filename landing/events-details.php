...
<!-- Mirrored from themeadapt.com/tm/eduvalt/events-details   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:48 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                                    ...
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Pages</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="events-details  ">Event Details</a></li>
    ...
    <main class="main-area fix">
                    ...
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem">Global Education Fall Meeting for Every Students Who Are Interested</span>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <!-- event-details-area -->
        <section class="event-details-area section-py-120">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-73">
                        <div class="event-details-content">
                            <h2 class="title">Global Education Fall Meeting for Every Students Who Are Interested</h2>
                            <div class="event-meta">
                                <ul class="list-wrap">
                                    <li><i class="flaticon-pin-1"></i>DNCC Party Hall, United Kingdom</li>
                                    <li><i class="flaticon-calendar-date"></i>25 Dec, 2023</li>
                                    <li><i class="flaticon-timer"></i>11:35 PM - 11:37 PM</li>
                                    <li><i class="flaticon-phone"></i>+123 599 8222</li>
                                </ul>
                            </div>
                            <div class="event-details-img">
                                <img src="assets/img/events/event_details_img.jpg" alt="img">
                            </div>
                            <h4 class="title-two">About The Event :</h4>
                            <p class="info-one">Grursus mal suada faci lisis Lorem ipsum dolarorit more ametion consectetur elit. Vesti at bulum nec odio aea the dumm ipsumm ipsum that dolocons rsus mal suada and fadolorit to the consectetur elit. All the Lorem Ipsum generators on the Internet tend to repeat that predefined chunks as necessary, making this the first true dummy generator on the Internet. It uses a dictionary of over 200 Latin words, combined Lorem Ipsum looks reasonable.</p>
                            <h4 class="title-two">During this event we’ll cover :</h4>
                            <p class="info-two">Grursus mal suada faci lisis Lorem ipsum dolarorit more ametion consectetur elit. Vesti at bulum nec odio aea the dumm ipsumm ipsum that dolocons rsus mal suada and fadolorit.</p>
                            <div class="event-details-list">
                                <ul class="list-wrap">
                                    <li><i class="fas fa-check-circle"></i>Become a UX designer.</li>
                                    <li><i class="fas fa-check-circle"></i>Create quick wireframes.</li>
                                    <li><i class="fas fa-check-circle"></i>You will be able to add UX designe</li>
                                    <li><i class="fas fa-check-circle"></i>Downloadable exercise files</li>
                                    <li><i class="fas fa-check-circle"></i>Become a UI designer.</li>
                                </ul>
                            </div>
                            <h4 class="title-two">Venue Map Direction:</h4>
                            <p class="info-three">Grursus mal suada faci lisis Lorem ipsum dolarorit more ametion consectetur elit. Vesti at bulum nec odio aea the dumm ipsumm ipsum that dolocons rsus mal suada and fadolorit.</p>
                    ...
                    <div class="col-27">
                        <aside class="event__sidebar">
                            <div class="event-widget">
                                <div class="speakers-content-top">
                                    <h4 class="ew-title">Our Speakers</h4>
                                    <div class="speakers-nav"></div>
                                </div>
                                <div class="speakers-active">
                                    <div class="speakers-item">
                                        <div class="speakers-thumb">
                                            <img src="assets/img/events/speaker_img01.jpg" alt="img">
                                        </div>
                                        <div class="speakers-content">
                                            <h2 class="title">Robert Smith</h2>
                            ...
                            <div class="event-widget">
                                <div class="event-cost-wrap">
                                    <h4 class="price"><strong>Costs:</strong>$25.00 <span>$84.99</span></h4>
                                    <a href="#" class="btn">Join Now</a>
                                    <div class="event-information-wrap">
                                        <h6 class="title">Information</h6>
                                        <ul class="list-wrap">
                                            <li><i class="flaticon-timer"></i>Duration <span>5.2 Hours</span></li>
                                            <li><i class="flaticon-file"></i>Estimated Seat <span>250</span></li>
                                            <li><i class="flaticon-user-1"></i>Joined <span>190</span></li>
                                            <li><i class="flaticon-bars"></i>Laguage <span>English</span></li>
                                            <li><i class="flaticon-flash"></i>Category <span>Desing</span></li>
...
<!-- Mirrored from themeadapt.com/tm/eduvalt/events-details   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:50 GMT -->
</html>