...
<body>
    ...
    <main class="main-area fix">
        ...
        <!-- mentors-area -->
        <section class="mentors-area section-pt-120 section-pb-90">
            <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="mentors__item">
                            ...
                            <div class="mentors__content">
                                ...
                                <div class="mentors__content-bottom">
                                    <ul class="list-wrap">
                                        <li class="students"><i class="flaticon-user-1"></i>1,235 Students</li>
                                        <li class="rating">
                                            <i class="fas fa-star"></i>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="mentors__item">
                            ...
                            <div class="mentors__content">
                                ...
                                <div class="mentors__content-bottom">
                                    <ul class="list-wrap">
                                        <li class="students"><i class="flaticon-user-1"></i>1,435 Students</li>
                                        <li class="rating">
                                            <i class="fas fa-star"></i>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="mentors__item">
                            ...
                            <div class="mentors__content">
                                ...
                                <div class="mentors__content-bottom">
                                    <ul class="list-wrap">
                                        <li class="students"><i class="flaticon-user-1"></i>1,835 Students</li>
                                        <li class="rating">
                                            <i class="fas fa-star"></i>
                                            <span class="rating-count">(5.0)</span>
                                        </li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="mentors__item">
                            ...
                            <div class="mentors__content">
                                ...
                                <div class="mentors__content-bottom">
                                    <ul class="list-wrap">
                                        <li class="students"><i class="flaticon-user-1"></i>1,335 Students</li>
                                        <li class="rating">
                                            <i class="fas fa-star"></i>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="mentors__item">
                            ...
                            <div class="mentors__content">
                                ...
                                <div class="mentors__content-bottom">
                                    <ul class="list-wrap">
                                        <li class="students"><i class="flaticon-user-1"></i>1,635 Students</li>
                                        <li class="rating">
                                            <i class="fas fa-star"></i>
