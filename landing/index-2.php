...
<!-- Mirrored from themeadapt.com/tm/eduvalt/index-2   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:21 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                            ...
                            <nav class="tgmenu__nav">
                                    ...
                                    <ul class="navigation">
                                        <li class="active menu-item-has-children"><a href="#">Home</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="index-2  ">Home Two</a></li>
                                ...
                                <div class="tgmenu__action">
                                    <ul class="list-wrap">
                                        ...
                                        <li class="header-phone d-none d-lg-block d-xl-none d-xxl-block"><a href="tel:993-00-67777"><i class="flaticon-phone-call"></i> 993-00-67777</a></li>
                                        <li class="header-btn login-btn"><a href="contact  " class="btn">Log in</a></li>
                                        <li class="header-btn"><a href="contact  " class="btn">Try For Free</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
    ...
    <main class="main-area fix">
                    ...
                    <div class="col-lg-6">
                        <div class="banner__content-two">
                            ...
                            <div class="banner__search-form">
                                ...
                                <p><a href="courses  ">You can access 7,900+ different courses</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row justify-content-center row-cols-1 row-cols-sm-2 row-cols-md-3">
                    ...
                    <div class="col">
                        <div class="categories__item-two tg-svg">
                            <a href="courses  ">
                                <div class="icon">
                                    <span class="svg-icon" id="cat_svg2" data-svg-icon="assets/img/icons/categories_icon.svg"></span>
                    ...
                    <div class="col">
                        <div class="categories__item-two tg-svg">
                            <a href="courses  ">
                                <div class="icon">
                                    <span class="svg-icon" id="cat_svg3" data-svg-icon="assets/img/icons/categories_icon.svg"></span>
                                    <i class="flaticon-bars"></i>
                                </div>
                                <div class="info">
                                    <span class="name">Finance</span>
                                    <span class="courses">22 Courses</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="categories__item-two tg-svg">
                            <a href="courses  ">
                                <div class="icon">
                                    <span class="svg-icon" id="cat_svg4" data-svg-icon="assets/img/icons/categories_icon.svg"></span>
                    ...
                    <div class="col">
                        <div class="categories__item-two tg-svg">
                            <a href="courses  ">
                                <div class="icon">
                                    <span class="svg-icon" id="cat_svg5" data-svg-icon="assets/img/icons/categories_icon.svg"></span>
                                    <i class="flaticon-atom"></i>
                                </div>
                                <div class="info">
                                    <span class="name">Science</span>
                                    <span class="courses">14 Courses</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="categories__item-two tg-svg">
                            <a href="courses  ">
                                <div class="icon">
                                    <span class="svg-icon" id="cat_svg6" data-svg-icon="assets/img/icons/categories_icon.svg"></span>
                                    <i class="flaticon-camera"></i>
                                </div>
                                <div class="info">
                                    <span class="name">Photography</span>
                                    <span class="courses">24 Courses</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col grid-item cat-one cat-three">
                        <div class="courses__item-two shine__animate-item">
                            ...
                            <div class="courses__item-two-content">
                                ...
                                <div class="courses__item-bottom">
                                    <div class="author">
                                        <a href="#"><img src="assets/img/courses/course_author05.png" alt="img"></a>
                                        <a href="#">Rehana Mia</a>
                                    </div>
                                    <div class="courses__item-rating">
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="col grid-item cat-two">
                        <div class="courses__item-two shine__animate-item">
                            ...
                            <div class="courses__item-two-content">
                                ...
                                <div class="courses__item-bottom">
                                    <div class="author">
                                        <a href="#"><img src="assets/img/courses/course_author06.png" alt="img"></a>
                                        <a href="#">William D.</a>
                                    </div>
                                    <div class="courses__item-rating">
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="col grid-item cat-two">
                        <div class="courses__item-two shine__animate-item">
                            ...
                            <div class="courses__item-two-content">
                                ...
                                <div class="courses__item-bottom">
                                    <div class="author">
                                        <a href="#"><img src="assets/img/courses/course_author07.png" alt="img"></a>
                                        <a href="#">Lana Rose</a>
                                    </div>
                                    <div class="courses__item-rating">
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="col grid-item cat-one cat-three">
                        <div class="courses__item-two shine__animate-item">
                            ...
                            <div class="courses__item-two-content">
                                ...
                                <div class="courses__item-bottom">
                                    <div class="author">
                                        <a href="#"><img src="assets/img/courses/course_author08.png" alt="img"></a>
                                        <a href="#">Arian Hok</a>
                                    </div>
                                    <div class="courses__item-rating">
                                        <i class="fas fa-star"></i>
        ...
        <!-- online-area -->
        <section class="online-area tg-motion-effects">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-7">
                        <div class="online__image-wrap">
                            ...
                            <img src="assets/img/icons/online_icons.png" alt="img" class="icons position-absolute">
                            <img src="assets/img/objects/online_01.png" alt="shape" class="left-shape position-absolute tg-motion-effects3">
                            <img src="assets/img/objects/online_02.png" alt="shape" class="top-shape position-absolute tg-motion-effects4">
                            <img src="assets/img/objects/online_03.svg" alt="shape" class="svg-shape position-absolute tg-motion-effects6">
                            <img src="assets/img/objects/categories_shape02.png" alt="shape" class="bottom-shape position-absolute tg-motion-effects3">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="online__content">
                            <div class="section__title">
                                <span class="sub-title">Unique online courses</span>
                                <h2 class="title">Online Learning <br> Courses Designed <br> For Real Life</h2>
                            </div>
                            ...
                            <div class="tg-button-wrap">
                                <a href="courses  " class="btn tg-svg"><span class="text">See All Categories</span> <span class="svg-icon" id="online-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
                            <img src="assets/img/objects/online_04.png" alt="shape" class="right-shape position-absolute tg-motion-effects5">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- mentors-area -->
        <section class="mentors-area position-relative section-pt-120 section-pb-90">
            <div class="container">
                    ...
                    <div class="row align-items-center gap-4 gap-md-0">
                        <div class="col-md-8">
                            <div class="section__title text-center text-md-start">
                                ...
                                <h2 class="title tg-svg">Top <span class="position-relative"><span class="svg-icon" id="svg-8" data-svg-icon="assets/img/icons/title_shape.svg"></span>Class</span> Mentors</h2>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="tg-button-wrap justify-content-center justify-content-md-end">
                                <a href="instructor  " class="btn btn-border tg-svg"><span class="text">All Instructors</span> <span class="svg-icon" id="mentors-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mentors__item">
                            ...
                            <div class="mentors__content">
                                ...
                                <div class="mentors__content-bottom">
                                    <ul class="list-wrap">
                                        <li class="students"><i class="flaticon-user-1"></i>1,135 Students</li>
                                        <li class="rating">
                                            <i class="fas fa-star"></i>
                                            <span class="rating-count">(5.0)</span>
                                        </li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="mentors__item">
                            ...
                            <div class="mentors__content">
                                ...
                                <div class="mentors__content-bottom">
                                    <ul class="list-wrap">
                                        <li class="students"><i class="flaticon-user-1"></i>3,235 Students</li>
                                        <li class="rating">
                                            <i class="fas fa-star"></i>
                                            <span class="rating-count">(4.7)</span>
                                        </li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="mentors__item">
                            ...
                            <div class="mentors__content">
                                ...
                                <div class="mentors__content-bottom">
                                    <ul class="list-wrap">
                                        <li class="students"><i class="flaticon-user-1"></i>2,235 Students</li>
                                        <li class="rating">
                                            <i class="fas fa-star"></i>
                                            <span class="rating-count">(4.2)</span>
                                        </li>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-8">
                        <div class="section__title text-center mb-50">
                            ...
                            <h2 class="title tg-svg">Latest <span class="position-relative"><span class="svg-icon" id="svg-10" data-svg-icon="assets/img/icons/title_shape.svg"></span>News</span> & Blog</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="blog__post-item-two shine__animate-item">
                            ...
                            <div class="blog__post-content-two">
                                ...
                                <h4 class="title"><a href="blog-details  ">when aeunkno printer took galley of scrambled</a></h4>
                    ...
                    <div class="col-lg-6">
                        <div class="blog__post-item-three shine__animate-item">
                            ...
                            <div class="blog__post-content-three">
                                ...
                                <h4 class="title"><a href="blog-details  ">When aeunkno printer get galley crambled</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 23 Aug, 2023</li>
                                </ul>
                        ...
                        <div class="blog__post-item-three shine__animate-item">
                            ...
                            <div class="blog__post-content-three">
                                ...
                                <h4 class="title"><a href="blog-details  ">Bhen aeunkno printer galley aewcram.</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 23 Aug, 2023</li>
                                </ul>
...
<!-- Mirrored from themeadapt.com/tm/eduvalt/index-2   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:33 GMT -->
</html>