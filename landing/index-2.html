...
<!-- Mirrored from themeadapt.com/tm/eduvalt/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:21 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <nav class="tgmenu__nav">
                                ...
                                <div class="tgmenu__action">
                                    <ul class="list-wrap">
                                        ...
                                        <li class="header-btn"><a href="contact.html" class="btn">Try For Free</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="online__content">
                            ...
                            <div class="tg-button-wrap">
                                <a href="courses.html" class="btn tg-svg"><span class="text">See All Categories</span> <span class="svg-icon" id="online-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
                    ...
                    <div class="row align-items-center gap-4 gap-md-0">
                        ...
                        <div class="col-md-4">
                            <div class="tg-button-wrap justify-content-center justify-content-md-end">
                                <a href="instructor.html" class="btn btn-border tg-svg"><span class="text">All Instructors</span> <span class="svg-icon" id="mentors-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="blog__post-item-two shine__animate-item">
                            ...
                            <div class="blog__post-content-two">
                                ...
                                <h4 class="title"><a href="blog-details.html">when aeunkno printer took galley of scrambled</a></h4>
                    ...
                    <div class="col-lg-6">
                        <div class="blog__post-item-three shine__animate-item">
                            ...
                            <div class="blog__post-content-three">
                                ...
                                <h4 class="title"><a href="blog-details.html">When aeunkno printer get galley crambled</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 23 Aug, 2023</li>
                                </ul>
                        ...
                        <div class="blog__post-item-three shine__animate-item">
                            ...
                            <div class="blog__post-content-three">
                                ...
                                <h4 class="title"><a href="blog-details.html">Bhen aeunkno printer galley aewcram.</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 23 Aug, 2023</li>
                                </ul>
...
<!-- Mirrored from themeadapt.com/tm/eduvalt/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:33 GMT -->
</html>