                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="courses__breadcrumb-content">
                            <a href="#" class="category">Graphic Design</a>
                            <h3 class="title">Essential Beginners UX/UI Core Course For You 2023</h3>
                        ...
                        <div class="courses__details-wrapper">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button" role="tab" aria-controls="info" aria-selected="true">Course Information</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                                        ...
                                        <div class="courses__details-inner">
                                            ...
                                            <div class="event-details-list">
                                                <ul class="list-wrap">
                                                    ...
                                                    <li><i class="fas fa-check-circle"></i>Build a UX project from beginning to end.</li>
                                                    <li><i class="fas fa-check-circle"></i>Build & test a full website design.</li>
                                                    <li><i class="fas fa-check-circle"></i>Learn to design websites & mobile</li>
                                                    <li><i class="fas fa-check-circle"></i>Create your first UX brief & persona.</li>
                                                    <li><i class="fas fa-check-circle"></i>All the techniques used by UX professionals</li>
                                                    <li><i class="fas fa-check-circle"></i>How to use premade UI kits.</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="courses__details-inner">
                                    ...
                                    <div class="courses__details-instructors">
                                        <h4 class="title">Your Instructors</h4>
                                ...
                                <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                                    <div class="courses__details-reviews">
                                        ...
                                        <div id="course-reviews">
                                            <h4 class="course-review-head">Reviews (01)</h4>
                                            <ul class="list-wrap">
                                                <li>
                                                    ...
                                                    <div class="review-author-info">
                                                        ...
                                                        <h5 class="user-name">Admin <span class="date">August 5, 2023</span></h5>
                                        ...
                                        <div class="course-review-form">
                                            <h4 class="course-review-head">Write a review</h4>
                                            <form action="#">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                ...
                                                <button class="btn">Submit your Review</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <aside class="courses__details-sidebar">
                            <div class="event-widget">
                                ...
                                <div class="event-cost-wrap">
                                    ...
                                    <a href="#" class="btn">Enroll This Now</a>
                                    <div class="event-information-wrap">
                                        <h6 class="title">Include This Course</h6>
                                        <ul class="list-wrap">
