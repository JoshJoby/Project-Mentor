                ...
                <div id='grid' class='item-content animate__animated animate__fadeIn active'
                    ...
                    <div class='row'>
                        ...
                        if (isset($_SESSION['admin_rows'])) {
                            ...
                            $expertRows = $_SESSION['admin_rows'];
                    ...
                    <div class='card-transparent card-block card-stretch card-height'>
                        <div class='card-body text-center p-0'>                            
                            <div class='item'>
                                <div class='odr-img'>
                                    <img src='" . ($row['admin_pfp'] != '' ? 'data:image/jpeg;base64,' . base64_encode($row['admin_pfp']) : '../assets/images/user/01.jpg') . "' class='img-fluid rounded-circle avatar-90 m-auto " . ($row['admin_status'] == 0 ? 'disabled-card' : '') . "' alt='Image'>
                                </div>                        
                                ...
                                if (isset($_SESSION['admin_rows'])) {
                                    ...
                                    <td>
                                        <div class='media align-items-center'>
                                            <img src='" . ($row['admin_pfp'] != '' ? 'data:image/jpeg;base64,' . base64_encode($row['admin_pfp']) : '../assets/images/user/01.jpg') . "'
