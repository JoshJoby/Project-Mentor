            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class=" ">
                    <a href="/ProjectMentor/expert/page-employee" class="svg-icon">
                        ...
                        <span class="ml-4">View Queries</span>
                    </a>
                </li>

                <li class=" ">
                    <a href="/ProjectMentor/expert/page-desk" class="svg-icon">
                    <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <span class="ml-4">Schedule Meet</span>
                    </a>
                </li>
                <!-- <li class="">
        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="/Project-Mentor-master/index.php" class="header-logo">
                    <h4 class="logo-title text-uppercase">Project Mentor</h4>
