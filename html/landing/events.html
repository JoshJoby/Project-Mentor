                                    ...
                                    <form action="#">
                                        ...
                                        <div class="form-grp">
                                            <select class="form-select" aria-label="Default select example">
                                                ...
                                                <option value="1">Attendance Based</option>
                                                <option value="2">Unscheduled Events</option>
                                                <option value="3">Scheduled Events</option>
                                            </select>
                                        </div>
                                        <div class="form-grp">
                                        ...
                                        <div class="form-grp">
                                            ...
                                            <i class="flaticon-searching fa-flip-horizontal"></i>
                                        </div>
