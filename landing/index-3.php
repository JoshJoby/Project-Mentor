...
<!-- Mirrored from themeadapt.com/tm/eduvalt/index-3   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:33 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="tgmenu__categories d-none d-md-block">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="courses  ">Business</a></li>
                                            <li><a class="dropdown-item" href="courses  ">Data Science</a></li>
                                            <li><a class="dropdown-item" href="courses  ">Art & Design</a></li>
                                            <li><a class="dropdown-item" href="courses  ">Marketing</a></li>
                                            <li><a class="dropdown-item" href="courses  ">Finance</a></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <ul class="navigation">
                                        <li class="active menu-item-has-children"><a href="#">Home</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="index-3  ">Home Three</a></li>
                                            </ul>
                                        </li>
    ...
    <main class="main-area fix">
        ...
        <section class="slider-area">
            <div class="slider__active">
                <div class="slider__item d-flex" data-background="assets/img/banner/slider_bg01.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-8">
                                <div class="slider__content">
                                    <span class="sub-title" data-animation-in="slideInLeft" data-delay-in=".2" data-duration-in="1.5">Any Time, Any Where To Do Discover Courses</span>
                                    <h2 class="title tg-svg" data-animation-in="slideInLeft" data-delay-in=".4" data-duration-in="1.5">Find The Best Suitable <span class="position-relative"><span class="svg-icon" id="slider-svg01" data-svg-icon="assets/img/icons/title_shape.svg"></span>Courses</span> From Here</h2>
                                    ...
                                    <div class="tg-button-wrap" data-animation-in="slideInLeft" data-delay-in=".8" data-duration-in="1.5">
                                        <a href="courses  " class="btn tg-svg"><span class="text">Explore Courses</span> <span class="svg-icon" id="slider-btn01" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <img src="assets/img/objects/categories_shape02.png" alt="shape" width="108" class="top-shape" data-animation-in="slideInDown" data-delay-in="1.2" data-duration-in="1.5">
                    <img src="assets/img/banner/slider_shape.png" alt="shape" class="bottom-shape" data-animation-in="slideInLeft" data-delay-in="1.2" data-duration-in="1.5">
                </div>
                <div class="slider__item d-flex" data-background="assets/img/banner/slider_bg02.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-8">
                                <div class="slider__content">
                                    <span class="sub-title" data-animation-in="slideInLeft" data-delay-in=".2" data-duration-in="1.5">Any Time, Any Where To Do Discover Courses</span>
                                    <h2 class="title tg-svg" data-animation-in="slideInLeft" data-delay-in=".4" data-duration-in="1.5">Find The Best Suitable <span class="position-relative"><span class="svg-icon" id="slider-svg02" data-svg-icon="assets/img/icons/title_shape.svg"></span>Courses</span> From Here</h2>
                                    <ul class="list-wrap" data-animation-in="slideInLeft" data-delay-in=".6" data-duration-in="1.5">
                                        <li><i class="fas fa-check-circle"></i>You can access 7,900+ different courses</li>
                                        <li><i class="fas fa-check-circle"></i>Lifetime Access For All</li>
                                    </ul>
                                    <div class="tg-button-wrap" data-animation-in="slideInLeft" data-delay-in=".8" data-duration-in="1.5">
                                        <a href="courses  " class="btn tg-svg"><span class="text">Explore Courses</span> <span class="svg-icon" id="slider-btn02" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="slider__item d-flex" data-background="assets/img/banner/slider_bg03.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-8">
                                <div class="slider__content">
                                    <span class="sub-title" data-animation-in="slideInLeft" data-delay-in=".2" data-duration-in="1.5">Any Time, Any Where To Do Discover Courses</span>
                                    <h2 class="title tg-svg" data-animation-in="slideInLeft" data-delay-in=".4" data-duration-in="1.5">Find The Best Suitable <span class="position-relative"><span class="svg-icon" id="slider-svg03" data-svg-icon="assets/img/icons/title_shape.svg"></span>Courses</span> From Here</h2>
                                    <ul class="list-wrap" data-animation-in="slideInLeft" data-delay-in=".6" data-duration-in="1.5">
                                        <li><i class="fas fa-check-circle"></i>You can access 7,900+ different courses</li>
                                        <li><i class="fas fa-check-circle"></i>Lifetime Access For All</li>
                                    </ul>
                                    <div class="tg-button-wrap" data-animation-in="slideInLeft" data-delay-in=".8" data-duration-in="1.5">
                                        <a href="courses  " class="btn tg-svg"><span class="text">Explore Courses</span> <span class="svg-icon" id="slider-btn03" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- quick-action-area -->
        <section class="quick__action-area section-pt-100 section-pb-70">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-10 col-sm-11">
                        <div class="quick__action-item" data-background="assets/img/bg/quick_action01.jpg">
                    ...
                    <div class="col-lg-6 col-md-10 col-sm-11">
                        <div class="quick__action-item" data-background="assets/img/bg/quick_action02.jpg">
                            <div class="quick__action-content">
                                <h4 class="title">Get unlimited access to 6,000+ of courses</h4>
                                <div class="tg-button-wrap">
                                    <a href="about-us  " class="btn white-btn tg-svg"><span class="text">Discover Now</span> <span class="svg-icon" id="discover-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- course-area -->
        <section class="courses-area-three position-relative section-pb-90">
            <div class="container">
                <div class="section__title-wrap mb-50">
                    <div class="row align-items-end">
                        <div class="col-lg-7">
                            <div class="section__title text-center text-lg-start">
                                <span class="sub-title">10,000+ Unique Online Courses</span>
                                <h2 class="title tg-svg">Recent <span class="position-relative"><span class="svg-icon" id="svg-4" data-svg-icon="assets/img/icons/title_shape.svg"></span>Trending</span> Courses</h2>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="tg-button-wrap mt-4 mt-lg-0 justify-content-center justify-content-lg-end">
                                <a href="courses  " class="btn btn-border tg-svg"><span class="text">View All Courses</span> <span class="svg-icon" id="course-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-7 col-md-9">
                        <div class="section__title text-center mb-50">
                            ...
                            <h2 class="title tg-svg">Grow You <span class="position-relative"><span class="svg-icon" id="fact-title" data-svg-icon="assets/img/icons/title_shape.svg"></span>Skills</span>To Advance Your Career path</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
        ...
        <!-- categories-area -->
        <section class="categories-area section-pt-120 section-pb-90">
            <div class="container">
                <div class="row align-items-center justify-content-center mb-55">
                    <div class="col-xl-7 col-lg-8 col-md-10">
                        <div class="categories__title-wrap text-center text-lg-start m-0">
                            <div class="section__title mb-0">
                                <span class="sub-title">Unique online courses</span>
                                <h2 class="title tg-svg">Browse By <span class="position-relative"><span class="svg-icon" id="svg-5" data-svg-icon="assets/img/icons/title_shape.svg"></span>Categories</span></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-4 col-md-6">
                        <div class="tg-button-wrap mt-4 mt-lg-0 justify-content-center justify-content-lg-end">
                            <a href="courses  " class="btn btn-border tg-svg"><span class="text">All Categories</span> <span class="svg-icon" id="svg-6" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="categories__item-three">
                            <a href="courses  ">
                                ...
                                <div class="info">
                                    <div class="list"><span class="courses">19 Courses</span></div>
                                    <div class="list"><span class="name">Graphic Design</span></div>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="categories__item-three">
                            <a href="courses  ">
                                ...
                                <div class="info">
                                    <div class="list"><span class="courses">22 Courses</span></div>
                                    <div class="list"><span class="name">Digital Marketing</span></div>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="categories__item-three">
                            <a href="courses  ">
                                ...
                                <div class="info">
                                    <div class="list"><span class="courses">40 Courses</span></div>
                                    <div class="list"><span class="name">Finance & Banking</span></div>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="categories__item-three">
                            <a href="courses  ">
                                ...
                                <div class="info">
                                    <div class="list"><span class="courses">24 Courses</span></div>
                                    <div class="list"><span class="name">Development</span></div>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="categories__shapes-two">
                <div class="categories__shapes-item-two rotateme">
                    <img src="assets/img/objects/categories_shape05.png" alt="shape">
                </div>
                <div class="categories__shapes-item-two" data-aos="fade-up">
        ...
        <section class="cta-area-two position-relative">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <div class="cta__content">
                            ...
                            <h2 class="title">50% Offer For Very First 50</h2>
                            <h5 class="sub-title">Student’s & Mentors</h5>
                            <div class="tg-button-wrap justify-content-center">
                                <a href="contact  " class="btn tg-svg"><span class="text">Become a Student</span> <span class="svg-icon" id="cta-btn-2" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="cta__shapes">
                <img src="assets/img/objects/cta_shape001.svg" alt="img" class="position-absolute" data-aos="fade-down-right" data-aos-delay="300">
                <img src="assets/img/objects/cta_shape002.png" alt="img" class="position-absolute">
                <img src="assets/img/objects/cta_shape003.svg" alt="img" class="position-absolute" data-aos="fade-up-left" data-aos-delay="300">
            </div>
        </section>
        <!-- cta-area-end -->

        <!-- events-area -->
        <section class="events-area position-relative section-pt-120 section-pb-90">
            <div class="container">
                    ...
                    <div class="row align-items-center gap-4 gap-md-0">
                        <div class="col-md-8">
                            <div class="section__title text-center text-md-start">
                                <span class="sub-title">Featured Events</span>
                                <h2 class="title tg-svg">Upcoming <span class="position-relative"><span class="svg-icon" id="event-svg" data-svg-icon="assets/img/icons/title_shape.svg"></span>Events</span></h2>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="tg-button-wrap justify-content-center justify-content-md-end">
                                <a href="instructor  " class="btn btn-border tg-svg"><span class="text">Our All Events</span> <span class="svg-icon" id="events-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-10">
                        <div class="events__item shine__animate-item">
                            ...
                            <div class="events__item-content">
                                <h4 class="title"><a href="events-details  ">Exactly How Technology Can Make Reading Better</a></h4>
        ...
        <!-- blog-area -->
        <section class="blog-area-two section-pt-120 section-pb-90">
            <div class="container">
                <div class="section__title-wrap mb-55">
                    <div class="row align-items-center gap-4 gap-md-0">
                        <div class="col-md-8">
                            <div class="section__title text-center text-md-start">
                                ...
                                <h2 class="title tg-svg">Our Latest <span class="position-relative"><span class="svg-icon" id="blog-two-svg" data-svg-icon="assets/img/icons/title_shape.svg"></span>Blog</span></h2>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="tg-button-wrap justify-content-center justify-content-md-end">
                                <a href="blog-grid  " class="btn btn-border tg-svg"><span class="text">See All Posts</span> <span class="svg-icon" id="blog-two-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog__post-item-four shine__animate-item">
                            <div class="blog__post-thumb-two">
                                <a href="blog-details  " class="shine__animate-link">
                                    <img src="assets/img/blog/blog_standard02.jpg" alt="img">
                                </a>
                            </div>
                            <div class="blog__post-content-two">
                                <a href="#" class="cat">Education</a>
                                <h4 class="title"><a href="blog-details  ">When printer took are gallery of scrambled</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 23 Aug, 2023</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog__post-item-four shine__animate-item">
                            ...
                            <div class="blog__post-content-two">
                                ...
                                <h4 class="title"><a href="blog-details  ">The Growing Need For Effective Password</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 23 Aug, 2023</li>
                                </ul>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog__post-item-four shine__animate-item">
                            ...
                            <div class="blog__post-content-two">
                                <a href="#" class="cat">Management</a>
                                <h4 class="title"><a href="blog-details  ">Make Your Magnificent Wallpapers Edition</a></h4>
                                <ul class="list-wrap blog__post-meta">
                                    <li><i class="flaticon-account"></i> by <a href="#">Admin</a></li>
                                    <li><i class="flaticon-calendar-date"></i> 23 Aug, 2023</li>
                                </ul>
            ...
            <img class="object" src="assets/img/objects/blog_shape03.png" width="76" style="left: 8%; top: 32%;" alt="Object">
            <img class="object rotateme" src="assets/img/objects/blog_shape04.png" width="66" style="right: 9%; bottom: 23%;" alt="Object">
        </section>
        <!-- blog-area-end -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="cta__wrapper">
                            ...
                            <div class="tg-button-wrap justify-content-center justify-content-md-end">
                                <a href="contact  " class="btn white-btn tg-svg"><span class="text">Become an Instructor</span> <span class="svg-icon" id="cta-btn" data-svg-icon="assets/img/icons/btn-arrow.svg"></span></a>
                            </div>
...
<!-- Mirrored from themeadapt.com/tm/eduvalt/index-3   by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2023 15:32:38 GMT -->
</html>