                            ...
                            <div class="col-xl-10 col-lg-10">
                                <div class="menu-wrapper d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">                                                                                          
                                                <li class="active" ><a href="/projectmentor.in/">Home</a></li>
                                                ...
                                                <!-- Button -->
                                                <li class="button-header margin-left "><a href="auth-sign-up.php" class="btn">Join</a></li>
                                                <li class="button-header"><a href="auth-sign-in.php" class="btn btn3">Log in</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
